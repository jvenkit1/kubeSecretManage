...
var rootCmd = &cobra.Command{
  Use:   "kubeSecretManage",
  Short: "A tool to orchestrate kubernetes secrets",
  Long: `A tool used for creating, listing, updating and deleting kubernetes secrets`,
...
func initConfig() {
  if cfgFile != "" {
    ...
    // Search config in home directory with name ".kubeSecretManage" (without extension).
    viper.AddConfigPath(home)
    viper.SetConfigName(".kubeSecretManage")
  }
